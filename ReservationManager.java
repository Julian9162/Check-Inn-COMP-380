...
public class ReservationManager {
    ...
    ArrayList<Integer> reservationID = new ArrayList<Integer>(); // Array list that stores reservation ID's
    ...
    public ReservationManager() {
        ...
        try {
            ...
            File file = new File("reservations.txt"); // Stores reservation list file
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Reservation r = new Reservation(Integer.parseInt(parts[0]), c, parts[2], Integer.parseInt(parts[3]), 
                                                parts[5], parts[6], activeStatus, parts[7]);
                // Store reservation object into reservation linked list
                reservation.add(r);
                // Store reservation object ID attribute into reservationID array
                reservationID.add(Integer.parseInt(parts[0]));
        ...
        // Error reading from reservation file
            ...
            System.out.println("I/O Error HotelManager " + e.getMessage());
        } // End catch
    ...
    public Reservation getReservation(int targetID) {
    ...
    private void removeFromReservationFile(Reservation r) {
        ...
        try{
            ...
            File oldFile = new File("reservations.txt"); // Stores old csv file
            File newFile = new File("temp.txt"); // Stores new csv file
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (r.getReservationID() != Integer.parseInt(parts[0])) {
            ...
            newFile.renameTo(new File("reservations.txt")); // Save new csv file
    ...
    public void removeReservation(int reservationNumber, int value) throws IOException{

        // Local variables
        ArchiveManager AM = new ArchiveManager();
        ReportManager ReM = new ReportManager();
        ...
        case 2:
            ReM.addEvent(r, "0", "Cancelled");
            AM.addToArchive(r, "Cancelled");
            break;
        // Customer never arrived to hotel
        case 1:
            ReM.addEvent(r, "0", "Absent");
            AM.addToArchive(r, "Absent");
            break;
        // Customer sucessfully completed their reservation
        case 0:
            ReM.addEvent(r, r.getRoomNumber(), "Completed");
            AM.addToArchive(r, "Complete");
    ...
    public void switchReservationStatus(Reservation r) {
        ...
        try{
            ...
            File oldFile = new File("reservations.txt"); // Store old csv file
            File newFile = new File("temp.txt"); // Store new csv file
            String checkIn = r.getCheckInDate().getMonthValue() + "/" + r.getCheckInDate().getDayOfMonth() + 
            ...
            newFile.renameTo(new File("reservations.txt")); // Save new file
