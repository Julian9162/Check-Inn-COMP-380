...
public class RoomManager {
    ...
    public void assignReservationNumber(String roomNumber, int reservationNumber) throws IOException {
        ...
        for (String[] roomDetails : rooms) {
            if (roomDetails[0].equals(roomNumber)) { 
                ...
                if (reservationNumber != 0) {
                    ...
                    Reservation r = rm.getReservation(reservationNumber);
                    r.setRoomNumber(roomDetails[3]);
                }
