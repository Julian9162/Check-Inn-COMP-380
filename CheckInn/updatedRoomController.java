...
/**
 * updatedRoomController ---    Updated Room Controller handles all the GUI for showing that a room's availability
 *                              status was set to true
 * Utilizes              ---    roomUpdated.fxml
...
public class updatedRoomController implements Initializable{
    ...
    /**
     Initializes the window to show the room's availability status was set to true
